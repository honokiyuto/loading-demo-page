...
const MoviePlayerComponent = ({ loadingType }: MoviePlayerComponentProps) => {
  return (
    <div className="flex flex-col">
      {/* 動画本体 */}
      <div className="aspect-video border-t-1 border-x-1 border-gray-300 dark:border-gray-800">
      ...
      {/* バー */}
      <div className="flex flex-row border-x-1 border-gray-300 dark:border-gray-800">
