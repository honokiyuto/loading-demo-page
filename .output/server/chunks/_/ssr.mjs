  ...
  const isMatch = (() => {
    ...
    for (let i = 0; i < Math.max(baseSegments.length, routeSegments.length); i++) {
      ...
      if (!isLastBaseSegment && isLastRouteSegment) {
        params["**"] = joinPaths(baseSegments.slice(i + 1).map((d2) => d2.value));
...
function processRouteTree({
  ...
  routes.forEach((d2, i) => {
    ...
    scoredRoutes.push({ child: d2, trimmed, parsed, index: i, scores });
  });
  ...
  return createServerFnStaticCache({
    getItem: async (ctx) => {
      if (typeof document === "undefined") {
        ...
        const publicUrl = "/Users/honokiyuto/myProjects/loading-demo-page/.output/public";
        const {
          promises: fs2
...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-CiFvmnDh.mjs');
    case VIRTUAL_MODULES.serverFnManifest:
      return await import('./_tanstack-start-server-fn-manifest_v-2IY6dDmr.mjs');
    default:
...
const globalCss = "/assets/global-DqoFGXT-.css";
...
const $$splitComponentImporter$1 = () => import('./about-T4h1qpIO.mjs');
...
const $$splitComponentImporter = () => import('./index-C1ovt-7f.mjs');
